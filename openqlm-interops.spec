...
###############################################################################
#
# openqlm-interops product packaging
#
###############################################################################

%define name openqlm-interops
...
# Package summary
Summary:        New product openqlm-interops
Name:           %{name}
Version:        %{version}
Release:        %{release}
Source:         %{src_tarall}
...
%description
openqlm-interops description

# Documenatation sub-package
%package doc
Summary: Documentation of the openqlm-interops package

%description doc
Doxygen documentation of openqlm-interops package

# Devel sub-package
%package devel
Summary: Header files providing the openqlm-interops API
Requires: %{name}

%description devel
Header files providing the openqlm-interops API

# Tests sub-package
%package tests
Requires: %{name}
Summary: Tests for the openqlm-interops library

%description tests
Test for the openqlm-interops library
