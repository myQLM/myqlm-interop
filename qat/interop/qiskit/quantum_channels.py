...
"""
@file qat/interop/qiskit/quantum_channels.py
@namespace ...
...
@brief  Functions qchannel_to_qiskit and qiskit_to_qchannel that translate
        a quantum channel representation between myqlm and qiskit.
"""
